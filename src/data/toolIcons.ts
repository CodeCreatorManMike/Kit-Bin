...
export const toolIcons: Record<string, IconPrimitive[]> = {
  ...
  /** JPG/PNG/WebP all share the plain "picture" glyph (circle + zigzag
   * horizon) in this set — only AVIF gets the dense-lines glyph above, since
   * it's the one format here treated as visually "compact." Box size just
   * alternates small→large/large→small per pair so the two icons in a
   * mirrored pair are never identical at card size. */
  '/image/jpg-to-png': [
    { t: 'fill', d: 'M2 6h7v9H2z' },
    { t: 'rect', x: 2, y: 6, w: 7, h: 9, rx: 1.4 },
    { t: 'circle', cx: 4.3, cy: 9, r: 0.85 },
    { t: 'path', d: 'M2 13h1.8l1.4-1.3 1.3 1.1 2.5-2.2' },
    { t: 'path', d: 'M11 10.5h2.5' },
    { t: 'path', d: 'M12.3 8.8l1.7 1.7-1.7 1.7' },
    { t: 'rect', x: 15, y: 6, w: 7.5, h: 9, rx: 1.4 },
    { t: 'circle', cx: 17.5, cy: 9, r: 0.85 },
    { t: 'path', d: 'M15 13.2l2-1.9 1.4 1.2 1.4-1.2 2.7 2.3' },
  ],
  '/image/png-to-jpg': [
    { t: 'fill', d: 'M2 6h7.5v9H2z' },
    { t: 'rect', x: 2, y: 6, w: 7.5, h: 9, rx: 1.4 },
    { t: 'circle', cx: 4.5, cy: 9, r: 0.85 },
    { t: 'path', d: 'M2 13.2l2-1.9 1.4 1.2 1.4-1.2 2.7 2.3' },
    { t: 'path', d: 'M11.5 10.5h2.5' },
    { t: 'path', d: 'M12.8 8.8l1.7 1.7-1.7 1.7' },
    { t: 'rect', x: 16, y: 6, w: 6, h: 9, rx: 1.4 },
    { t: 'circle', cx: 18, cy: 9, r: 0.85 },
    { t: 'path', d: 'M16 13l1.6-1.5 1.2 1 2.2-1.9' },
  ],
  '/image/jpg-to-webp': [
    { t: 'fill', d: 'M2 6h8v9H2z' },
    { t: 'rect', x: 2, y: 6, w: 8, h: 9, rx: 1.4 },
    { t: 'circle', cx: 4.5, cy: 9, r: 0.85 },
    { t: 'path', d: 'M2 13.2l2.2-2 1.5 1.3 1.5-1.3 2.8 2.4' },
    { t: 'path', d: 'M12 10.5h2.5' },
    { t: 'path', d: 'M13.3 8.8l1.7 1.7-1.7 1.7' },
    { t: 'rect', x: 16.5, y: 6, w: 5.5, h: 9, rx: 1.4 },
    { t: 'circle', cx: 18.2, cy: 9, r: 0.85 },
    { t: 'path', d: 'M16.5 13l1.5-1.4 1.1 0.9 2-1.7' },
  ],
  '/image/webp-to-jpg': [
    { t: 'fill', d: 'M2 6h5.5v9H2z' },
    { t: 'rect', x: 2, y: 6, w: 5.5, h: 9, rx: 1.4 },
    { t: 'circle', cx: 3.8, cy: 9, r: 0.85 },
    { t: 'path', d: 'M2 13l1.5-1.4 1.1 0.9 2-1.7' },
    { t: 'path', d: 'M9 10.5h2.5' },
    { t: 'path', d: 'M10.3 8.8l1.7 1.7-1.7 1.7' },
    { t: 'rect', x: 14, y: 6, w: 8, h: 9, rx: 1.4 },
    { t: 'circle', cx: 16.5, cy: 9, r: 0.85 },
    { t: 'path', d: 'M14 13.2l2.2-2 1.5 1.3 1.5-1.3 2.8 2.4' },
  ],
  /** PNG/WebP get the picture glyph; AVIF reuses the dense-lines glyph from
   * the avif-to-jpg/jpg-to-avif pair above, for the same "compact format"
   * visual convention. */
  '/image/png-to-avif': [
    { t: 'fill', d: 'M2 6h8.5v9H2z' },
    { t: 'rect', x: 2, y: 6, w: 8.5, h: 9, rx: 1.4 },
  ...
  /** Reuses heic-to-jpg's HEIC glyph (rounded square + small circle +
   * diagonal check-mark-like stroke) on the source side, picture glyph on
   * the target side. */
  '/image/heic-to-png': [
    { t: 'fill', d: 'M2 5h9v14H2z' },
    { t: 'rect', x: 2, y: 5, w: 9, h: 14, rx: 1.5 },
    { t: 'circle', cx: 5, cy: 8.7, r: 1.1 },
    { t: 'path', d: 'M2 15l2.8-2.8a0.9 0.9 0 0 1 1.3 0L9 15.5' },
    { t: 'path', d: 'M13.5 12h2.3' },
    { t: 'path', d: 'M14.7 10.3l1.7 1.7-1.7 1.7' },
    { t: 'rect', x: 17.5, y: 8, w: 5.5, h: 9, rx: 1.3 },
    { t: 'circle', cx: 19.5, cy: 10.8, r: 0.75 },
    { t: 'path', d: 'M17.5 15.2l2-1.9 1.4 1.2 1.9-1.6' },
  ],
  '/image/heic-to-webp': [
    { t: 'fill', d: 'M2 5h9v14H2z' },
    { t: 'rect', x: 2, y: 5, w: 9, h: 14, rx: 1.5 },
    ...
    { t: 'path', d: 'M13.5 12h2.3' },
    { t: 'path', d: 'M14.7 10.3l1.7 1.7-1.7 1.7' },
    { t: 'rect', x: 17.5, y: 8, w: 5, h: 9, rx: 1.3 },
    { t: 'circle', cx: 19.3, cy: 10.8, r: 0.75 },
    { t: 'path', d: 'M17.5 15l1.8-1.7 1.2 1 1.7-1.5' },
  ],
  /** Compress-* pages share the single-box squeeze-arrows glyph from
   * '/image/compress' — same operation, just scoped to one format, so the
   * icon intentionally doesn't try to invent a per-format variant. */
  '/image/compress-jpg': [
    { t: 'fill', d: 'M3 4h16a0 0 0 0 1 0 0v13a0 0 0 0 1 0 0H3a0 0 0 0 1 0 0V4a0 0 0 0 1 0 0z' },
    { t: 'rect', x: 3, y: 4, w: 16, h: 13, rx: 1.5 },
    { t: 'path', d: 'M8 20h8' },
